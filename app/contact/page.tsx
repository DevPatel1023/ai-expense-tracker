  ...
  return (
    <div className='font-sans bg-gradient-to-br from-gray-50 via-white to-orange-50  text-gray-800 transition-all duration-300 min-h-screen'>
      ...
      <section className='relative overflow-hidden flex flex-col items-center justify-center text-center py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-br from-orange-500/10 via-amber-500/5 to-yellow-500/10 '>
        ...
        <div className='relative z-10 max-w-4xl mx-auto w-full'>
          ...
          <div className='mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0'>
            ...
            <Link
              href='/contact'
              className='group border-2 border-orange-500/20  text-orange-600  hover:bg-orange-50  px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold transition-all duration-200 backdrop-blur-sm'
            >
              Learn More
            </Link>
          </div>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='group relative bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50  hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              <div className='absolute inset-0 bg-gradient-to-br from-orange-500/5 to-amber-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200'></div>
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-orange-500 via-amber-500 to-yellow-500 rounded-xl flex items-center justify-center shadow-lg mb-6'>
            ...
            <div className='group relative bg-white/80  backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50  hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-amber-500 via-yellow-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg mb-6'>
                  <span className='text-white text-xl'>✨</span>
                </div>
                <h3 className='text-xl font-bold mb-4 text-gray-900 '>
            ...
            <div className='group relative bg-white/80  backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50  hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              <div className='absolute inset-0 bg-gradient-to-br from-yellow-500/5 to-orange-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200'></div>
              <div className='relative z-10'>
      ...
      <section className='py-20 px-8 bg-white/80  backdrop-blur-sm relative overflow-hidden'>
        ...
        <div className='absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-yellow-500/5 to-orange-500/5 rounded-full blur-2xl'></div>
      ...
      <section className='py-20 px-8 bg-gradient-to-br from-gray-50 via-white to-orange-50  relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto text-center relative z-10'>
          ...
          <div className='flex flex-col sm:flex-row gap-6 justify-center items-center'>
            ...
            <Link
              href='/contact'
              className='group border-2 border-orange-500/20  text-orange-600  hover:bg-orange-50  px-8 py-4 rounded-2xl font-semibold transition-all duration-200 backdrop-blur-sm flex items-center gap-2'
            >
              Contact Us
