        ...
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            ...
            <div className="hidden sm:block">
              ...
              <SignedIn>
                <div className="p-0.5 sm:p-1 rounded-lg sm:rounded-xl">
                  <UserButton
                    appearance={{
                      elements: {
                        avatarBox:
            ...
            <button
              ...
              className="md:hidden p-1.5 sm:p-2 rounded-lg sm:rounded-xl text-black  hover:text-white  hover:hover:bg-secondary dark:hover:bg-secondary transition-all duration-200 active:scale-95"
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-600/50 mt-2 shadow-lg">
            ...
            <div className="pt-3 border-t border-gray-200/50 dark:border-gray-600/50">
              <SignedOut>
                <SignInButton>
                  <button
                    className="w-full text-white px-4 py-3 rounded-xl text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 active:scale-95"
                    onClick={closeMobileMenu}
                  >
                    <span>Sign In</span>
                    <svg
