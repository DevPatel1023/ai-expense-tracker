...
export default function Navbar() {
  ...
  return (
    <nav className='sticky top-0 z-50 bg-background dark:bg-gray-900/95 backdrop-blur supports-[backdrop-filter]:bg-card/60 border-b border-gray-200/50  shadow-lg shadow-gray-900/5 dark:shadow-black/30'>
        ...
        >
          <div className='px-2 pt-2 pb-3 space-y-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-600/50 mt-2 shadow-lg'>
            ...
            <Link
              ...
              onClick={closeMobileMenu}
            >
              <span className='text-base'><House size="18" />
</span>
              <span>Home</span>
            </Link>
            <Link
            ...
            <Link
              ...
              onClick={closeMobileMenu}
            >
              <span className='text-base'><Phone size="18" /></span>
              <span>Contact</span>
            </Link>
